# NFR Requirements — Team Override (Addendum)

> **This is an addendum, not a replacement.** Load the full stage rules from
> `.aidlc-rule-details/construction/nfr-requirements.md` first, then apply this override.
...
- `aidlc-docs/{domain}/{unit}/construction/nfr-requirements/` (all files)
- Reference: requirements.md, functional design artifacts
