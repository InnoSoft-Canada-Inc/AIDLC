# Infrastructure Design — Team Override (Addendum)

> **This is an addendum, not a replacement.** Load the full stage rules from
> `.aidlc-rule-details/construction/infrastructure-design.md` first, then apply this override.
...
- `aidlc-docs/{domain}/{unit}/construction/infrastructure-design/` (all files)
- Reference: NFR design, functional design, requirements.md
