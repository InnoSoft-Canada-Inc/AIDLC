...
### 7.1 Determine Execution Plan Location

**Location logic**:
- **Single unit of work**: `aidlc-docs/{domain}/{unit}/inception/plans/execution-plan.md`
- **Cross-domain plan**: `aidlc-docs/_shared/plans/execution-plan.md`

**How to determine**:
1. Check `aidlc-docs/aidlc-state.md` for active unit ID and domain
2. If unit ID exists (e.g., `BILL-001`): Use unit-specific path
3. If no unit ID (cross-domain coordination): Use `_shared/` path

**Default**: Use unit-specific path unless plan coordinates work across multiple domains or no unit context exists.

### 7.2 Create Execution Plan Document

At the determined location, create execution plan with this structure:
...
> **📋 <u>**REVIEW REQUIRED:**</u>**
> Please examine the execution plan at: `aidlc-docs/{domain}/{unit}/inception/plans/execution-plan.md` (or `aidlc-docs/_shared/plans/execution-plan.md` if cross-domain)
