...
- [ ] Generate `aidlc-docs/_shared/application-design/unit-of-work.md` with unit definitions and responsibilities
- [ ] Generate `aidlc-docs/_shared/application-design/unit-of-work-dependency.md` with dependency matrix
- [ ] Generate `aidlc-docs/_shared/application-design/unit-of-work-story-map.md` mapping stories to units
...
- Save as `aidlc-docs/_shared/plans/unit-of-work-plan.md`
...
- Ask: "**Unit of work plan complete. Review the plan in aidlc-docs/_shared/plans/unit-of-work-plan.md. Ready to proceed to generation?**"
...
- [ ] Read the complete plan from `aidlc-docs/_shared/plans/unit-of-work-plan.md`
...
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the units generation artifacts at: `aidlc-docs/_shared/application-design/`
...
When creating unit folders during generation, use the naming convention:
...
**Derivation**:
1. Take the unit name/description (e.g., "User Authentication with JWT")
...
See `common/backlog.md` for complete naming rules and edge cases.
...
- Unit folders created with proper naming convention
