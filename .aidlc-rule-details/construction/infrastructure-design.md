...
- Read functional design from `aidlc-docs/{domain}/{unit}/construction/functional-design/`
- Read NFR design from `aidlc-docs/{domain}/{unit}/construction/nfr-design/` (if exists)
...
### Step 4: Store Plan
- Save as `aidlc-docs/{domain}/{unit}/construction/plans/{unit-name}-infrastructure-design-plan.md`
...
- Create `aidlc-docs/{domain}/{unit}/construction/infrastructure-design/infrastructure-design.md`
- Create `aidlc-docs/{domain}/{unit}/construction/infrastructure-design/deployment-architecture.md`
- If shared infrastructure: Create `aidlc-docs/_shared/shared-infrastructure.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the infrastructure design at: `aidlc-docs/{domain}/{unit}/construction/infrastructure-design/`
