...
- Read NFR requirements from `aidlc-docs/{domain}/{unit}/construction/nfr-requirements/`
...
### Step 4: Store Plan
- Save as `aidlc-docs/{domain}/{unit}/construction/plans/{unit-name}-nfr-design-plan.md`
...
- Create `aidlc-docs/{domain}/{unit}/construction/nfr-design/nfr-design-patterns.md`
- Create `aidlc-docs/{domain}/{unit}/construction/nfr-design/logical-components.md`
...
```markdown
> **📋 <u>**REVIEW REQUIRED:**</u>**  
> Please examine the NFR design at: `aidlc-docs/{domain}/{unit}/construction/nfr-design/`
